...
Beniget historically relied on `gast <https://pypi.org/project/gast/>`_ to provide a cross
version abstraction of the AST, effectively working on both Python2 and
Python3. Starting at Python 3.6, beniget is compatible with the standard library AST.
